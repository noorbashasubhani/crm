            ...
            <div className="main-panel mt-0">
                <div className="content-wrapper">
                    <div className="page-header">
                        <h3 className="page-title"> Holidays  Details </h3>
                                    ...
                                    <table className="table table-dark" style={{ overflowX: 'scroll', display: 'block' }}>
                                        <thead>
                                            <tr>
                                                <th scope="col">#</th>
                                                <th scope="col">Day </th>
                                                <th scope="col" style={{minWidth:'50px'}}>Holiday Name</th>
                                        ...
                                        <tbody>
                                            {holiday.map((items, index) => (
                                                ...
                                                <tr key={index}>
                                                    <td>{index + 1}</td>
                                                    <td>{humandateonly(items.day)}</td>
                                                    <td>{items.name}</td>
                                                    <td>{humandateonly(items.cteated_date)}</td>
