...
const Notifictins = () => {
    ...
    useEffect(() => {
        axios.get('http://localhost:5000/notificationDetails')
            .then((response) => {
                setNoti(response.data.data); // Assuming response.data is an array of image objects
                                        ...
                                        <tbody>
                                            {noti.map((noti, index) => (
                                                <tr key={noti.id}>
                                                    <td>{index + 1}</td>
                                                    <td>
                                                        <p className="text-primary">Notification  From : {getUserNameById(noti.from_id)} </p>
                                                        <b>
                                                             {noti.message_heading}</b>
                                                         <p>{noti.message_body}</p>
                                                         -<span className="text-black text-danger">{noti.created_date}</span>
