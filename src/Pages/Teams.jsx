            ...
            <div className="main-panel mt-0">
                <div className="content-wrapper">
                    <div className="page-header">
                        <h3 className="page-title"> Team  Details </h3>
                                    ...
                                    <table className="table table-dark" style={{ overflowX: 'scroll', display: 'block' }}>
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" style={{minWidth:'50px'}}>Dept Name</th>
                                        ...
                                        <tbody>
                                            ...
                                            items.partner_type !=='' ? 
                                                ...
                                                <tr key={index}>
                                                    ...
                                                    <td>{deptName(items.dept_id)}</td>
                                                    <td>{getUserNameById(items.dept_head)}</td>
                                                    <td>{getUserNameById(items.dept_lead)}</td>
                                                    <td>{getUserNamesByIds(items.emp_ids)}</td>
