...
import DomesticVochers from './DomesticVochers.jsx';
import InternationalVochers from './InternationalVochers';
import CompletedVochers from './CompletedVochers';

const VochersLanding = () => {
    ...
    <div className="container-fluid page-body-wrapper">
      ...
      <div className="main-panel mt-0">
        <div className="content-wrapper">
          ...
          {view === 'domestic' && <DomesticVochers />}
          {view === 'international' && <InternationalVochers />}
          {view === 'completed' && <CompletedVochers />}
        </div>
